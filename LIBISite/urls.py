...
urlpatterns += [
    path('libiapp/',include('libiapp.urls')),
...
urlpatterns += [
    path('',RedirectView.as_view(url='/libiapp/',permanent=True)),
...
# Add Django site autentication urls (for login, logout, password management)
