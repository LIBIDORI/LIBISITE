...
class AuthorCreate(PermissionRequiredMixin,CreateView):
    ...
    permission_required = 'catalog.puede_crear_modificar_borrar'
...
class BookCreate(CreateView):
    model = Book
    fields = '__all__'
#   initial = {'Nombre_del_Campo':'Valor_Inicial',}
#   permission_required = 'catalog.Nombre_del_permiso' El nombre_del_permiso es el nombre con el que se ha creado en el modelo
